...
Atomic transactions utilize Shared Memory (documented [here](https://github.com/dim4egster/qmallgo/blob/master/chains/atomic/README.md)) to send assets to the P-Chain and X-Chain.
