...
## [v0.10.0](https://github.com/dim4egster/coreth/releases/tag/v0.10.0)
...
## [v0.9.0](https://github.com/dim4egster/coreth/releases/tag/v0.9.0)

- Migrate to go-ethereum v1.10.23
- Add API to fetch Chain Config

## [v0.8.16](https://github.com/dim4egster/coreth/releases/tag/v0.8.16)
...
## [v0.8.15](https://github.com/dim4egster/coreth/releases/tag/v0.8.15)
...
## [v0.8.14](https://github.com/dim4egster/coreth/releases/tag/v0.8.14)
...
## [v0.8.13](https://github.com/dim4egster/coreth/releases/tag/v0.8.13)

- Bump go-ethereum dependency to v1.10.18
- Parallelize state sync code fetching
- Deprecated CB58 format for API calls

## [v0.8.12](https://github.com/dim4egster/coreth/releases/tag/v0.8.12)
...
## [v0.8.11](https://github.com/dim4egster/coreth/releases/tag/v0.8.11)
...
## [v0.8.10](https://github.com/dim4egster/coreth/releases/tag/v0.8.10)

- Add beta support for fast sync
- Bump trie tip buffer size to 32
- Fix bug in metrics initialization

## [v0.8.9](https://github.com/dim4egster/coreth/releases/tag/v0.8.9)
...
## [v0.8.8](https://github.com/dim4egster/coreth/releases/tag/v0.8.8)
...
## [v0.8.7](https://github.com/dim4egster/coreth/releases/tag/v0.8.7)
...
## [v0.8.6](https://github.com/dim4egster/coreth/releases/tag/v0.8.6)
...
## [v0.8.5](https://github.com/dim4egster/coreth/releases/tag/v0.8.5)
