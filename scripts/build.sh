...
go build -ldflags "-X github.com/dim4egster/coreth/plugin/evm.GitCommit=$coreth_commit -X github.com/dim4egster/coreth/plugin/evm.Version=$coreth_version" -o "$binary_path" "plugin/"*.go
